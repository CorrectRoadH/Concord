...
export interface TakeoverCertificateV2 {
    readonly format: "niceeval.e2e-takeover-certificate/v2";
    readonly selector: string;
    readonly caseId: string;
    readonly candidateSha256: string;
    readonly sourceDigest: string;
    readonly greenReceipt: string;
    readonly observations: TakeoverCertificateV1["observations"];
    readonly certificateSha256: string;
}
...
export declare const signFormalCaseReceipt: (unsigned: Omit<FormalCaseReceiptV2, "receiptSha256">) => FormalCaseReceiptV2;
export declare const validateFormalCaseReceipt: (input: unknown) => FormalCaseReceipt;
export declare const signTakeoverCertificate: (unsigned: Omit<TakeoverCertificateV2, "certificateSha256">) => TakeoverCertificateV2;
export declare const validateTakeoverCertificate: (input: unknown, receipts: ReadonlyMap<string, FormalCaseReceipt>) => TakeoverCertificate;
